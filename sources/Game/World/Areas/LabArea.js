    ...
    setImages()
    {
        ...
        this.images.getResourceAndLoad = (key) =>
        {
            ...
            if(!resource)
            {
                ...
                const loaderType = key.endsWith('.png') || key.endsWith('.jpg') || key.endsWith('.jpeg') || key.endsWith('.webp') ? 'texture' : 'textureKtx'
            ...
            for(const project of labData)
            {
                ...
                // Image
                {
                    ...
                    mini.startLoading = () =>
                    {
                        ...
                        const miniLoaderType = miniKey.endsWith('.png') || miniKey.endsWith('.jpg') || miniKey.endsWith('.jpeg') || miniKey.endsWith('.webp') ? 'texture' : 'textureKtx'
                        const loader = this.game.resourcesLoader.getLoader(miniLoaderType)
